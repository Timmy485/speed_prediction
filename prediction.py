...
test_data = pd.read_csv('/srv/beegfs02/scratch/aegis_guardian/data/Datasets_ML_Pipeline/Drive360Challenge/Drive360Images/drive360challenge_test_solution.csv')
test_data = test_data[['cameraRight', 'canSpeed']]
test_data.rename({'cameraRight': 'image_path', 'canSpeed': 'speed'}, axis=1, inplace=True)
test_data['speed'] = [i/36.89 for i in test_data.speed]
...
plt.title('Ground Truth vs Predictions')
plt.legend(['ground truth', 'predictions'])
plt.savefig('/srv/beegfs02/scratch/aegis_guardian/data/speed_prediction/deeps/Drive360Predictions.jpg')